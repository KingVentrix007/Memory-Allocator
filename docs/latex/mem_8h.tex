\hypertarget{mem_8h}{}\doxysection{lowlevel/mem.h File Reference}
\label{mem_8h}\index{lowlevel/mem.h@{lowlevel/mem.h}}


Memory Allocation Implementation Definitions.  
...
\begin{DoxyCompactList}\small\item\em \mbox{\hyperlink{structNode}{Node}} structure for representing a memory region. ~\newline
 \end{DoxyCompactList}\item 
struct \mbox{\hyperlink{structMemoryAllocationInfo}{Memory\+Allocation\+Info}}
\begin{DoxyCompactList}\small\item\em Structure for representing memory allocation information. \end{DoxyCompactList}\item 
struct \mbox{\hyperlink{structFreeZone}{Free\+Zone}}
\begin{DoxyCompactList}\small\item\em Structure for representing a free memory zone. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Typedefs}
\begin{DoxyCompactItemize}
\item 
typedef struct \mbox{\hyperlink{structNode}{Node}} \mbox{\hyperlink{mem_8h_a3b09f37e675bcd48a01bf22155996872}{Node}}
\begin{DoxyCompactList}\small\item\em \mbox{\hyperlink{structNode}{Node}} structure for representing a memory region. ~\newline
 \end{DoxyCompactList}\item 
typedef struct \mbox{\hyperlink{structFreeZone}{Free\+Zone}} \mbox{\hyperlink{mem_8h_a1f904decdfa44aacbe664d82fce59974}{Free\+Zone}}
\begin{DoxyCompactList}\small\item\em Structure for representing a free memory zone. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{mem_8h_a01d9aa05cca676db51d106a9703ad541}{init\+\_\+memory\+\_\+allocation}} (void $\ast$start\+\_\+addr, size\+\_\+t size)
\begin{DoxyCompactList}\small\item\em Initializes memory allocation. \end{DoxyCompactList}\item 
void $\ast$ \mbox{\hyperlink{mem_8h_a7b9a0e78f9993c8f45e8ccaea7f14dd5}{sys\+\_\+allocate\+\_\+memory}} (int size)
...
void $\ast$ \mbox{\hyperlink{mem_8h_a406fd90a3f95c858165853e109fe7271}{sys\+\_\+free\+\_\+memory}} (const void $\ast$addr)
...
void $\ast$ \mbox{\hyperlink{mem_8h_aa2cb60350e8b0887063d3976054b6769}{sys\+\_\+reallocate\+\_\+memory}} (void $\ast$addr, int old\+\_\+size, int new\+\_\+size)
\begin{DoxyCompactList}\small\item\em Reallocates memory for a previously allocated block and updates the linked list. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{mem_8h_a675d7a0529f784a7c298b19a64e7d08e}{find\+\_\+dangling\+\_\+pointer}} ()
...
void \mbox{\hyperlink{mem_8h_a18e1848dd1f6ac2ef3a214ef6b157af2}{print\+\_\+memory\+\_\+info}} ()
\begin{DoxyCompactList}\small\item\em Prints information about the memory. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{mem_8h_a6edaee3ea2b783507029f348655a1374}{extend\+\_\+allocation\+\_\+space}} (void $\ast$extra\+\_\+region, size\+\_\+t size)
...
void $\ast$ \mbox{\hyperlink{mem_8h_a350fdfeaa16470a038585904910c0973}{init\+\_\+memory\+\_\+region}} (void $\ast$start\+\_\+addr, size\+\_\+t size)
\begin{DoxyCompactList}\small\item\em Initializes the memory region for allocation. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{mem_8h_a53bcc9c1f4fe098b102b72a97af1cb38}{print\+\_\+node\+\_\+info}} (const \mbox{\hyperlink{structNode}{Node}} $\ast$node)
\begin{DoxyCompactList}\small\item\em Prints information about a given node. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{mem_8h_a1e0067276a6f470f8744cde11001611b}\label{mem_8h_a1e0067276a6f470f8744cde11001611b}} 
int $\ast$ {\bfseries run\+\_\+checks} ()
\item 
size\+\_\+t \mbox{\hyperlink{mem_8h_afcde9dfb4a3501997defaf0629f3729f}{get\+\_\+memory\+\_\+size}} (const void $\ast$ptr)
...
\mbox{\Hypertarget{mem_8h_a3b64fe9302be1d3722a1d8496112f2c2}\label{mem_8h_a3b64fe9302be1d3722a1d8496112f2c2}} 
int {\bfseries main\+\_\+automated\+\_\+testing} ()
\item 
\mbox{\Hypertarget{mem_8h_a8e41936220eae4ee5b67afc98d316b7f}\label{mem_8h_a8e41936220eae4ee5b67afc98d316b7f}} 
int {\bfseries main\+\_\+automated\+\_\+testing\+\_\+end} ()
\item 
int \mbox{\hyperlink{mem_8h_a528f68e26e73ebabf3a07b18274948a8}{buffer\+\_\+overflow\+\_\+detector}} ()
\begin{DoxyCompactList}\small\item\em Detects buffer overflows by checking for non-\/zero bytes in the allocated memory regions. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\Hypertarget{mem_8h_a1f904decdfa44aacbe664d82fce59974}\label{mem_8h_a1f904decdfa44aacbe664d82fce59974}} 
\index{mem.h@{mem.h}!FreeZone@{FreeZone}}
\index{FreeZone@{FreeZone}!mem.h@{mem.h}}
\doxysubsubsection{\texorpdfstring{FreeZone}{FreeZone}}
{\footnotesize\ttfamily typedef struct \mbox{\hyperlink{structFreeZone}{Free\+Zone}} \mbox{\hyperlink{structFreeZone}{Free\+Zone}}}
...
\end{DoxyItemize}\mbox{\Hypertarget{mem_8h_a3b09f37e675bcd48a01bf22155996872}\label{mem_8h_a3b09f37e675bcd48a01bf22155996872}} 
\index{mem.h@{mem.h}!Node@{Node}}
\index{Node@{Node}!mem.h@{mem.h}}
...
\mbox{\Hypertarget{mem_8h_a528f68e26e73ebabf3a07b18274948a8}\label{mem_8h_a528f68e26e73ebabf3a07b18274948a8}} 
\index{mem.h@{mem.h}!buffer\_overflow\_detector@{buffer\_overflow\_detector}}
\index{buffer\_overflow\_detector@{buffer\_overflow\_detector}!mem.h@{mem.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{mem_8h_a6edaee3ea2b783507029f348655a1374}\label{mem_8h_a6edaee3ea2b783507029f348655a1374}} 
\index{mem.h@{mem.h}!extend\_allocation\_space@{extend\_allocation\_space}}
\index{extend\_allocation\_space@{extend\_allocation\_space}!mem.h@{mem.h}}
...
None. 
\end{DoxyReturn}
CURRENTLY BROKEN\mbox{\Hypertarget{mem_8h_a675d7a0529f784a7c298b19a64e7d08e}\label{mem_8h_a675d7a0529f784a7c298b19a64e7d08e}} 
\index{mem.h@{mem.h}!find\_dangling\_pointer@{find\_dangling\_pointer}}
\index{find\_dangling\_pointer@{find\_dangling\_pointer}!mem.h@{mem.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{mem_8h_afcde9dfb4a3501997defaf0629f3729f}\label{mem_8h_afcde9dfb4a3501997defaf0629f3729f}} 
\index{mem.h@{mem.h}!get\_memory\_size@{get\_memory\_size}}
\index{get\_memory\_size@{get\_memory\_size}!mem.h@{mem.h}}
...
Function Name\+: get\+\_\+memory\+\_\+size Description\+: Retrieves the size of the allocated memory block pointed to by ptr.

!! WARNING !! None.

Parameters\+: ptr (void$\ast$) -\/ Pointer to the memory block.

Return\+: size\+\_\+t -\/ The size of the allocated memory block.
...
\end{DoxyReturn}
\mbox{\Hypertarget{mem_8h_a01d9aa05cca676db51d106a9703ad541}\label{mem_8h_a01d9aa05cca676db51d106a9703ad541}} 
\index{mem.h@{mem.h}!init\_memory\_allocation@{init\_memory\_allocation}}
\index{init\_memory\_allocation@{init\_memory\_allocation}!mem.h@{mem.h}}
\doxysubsubsection{\texorpdfstring{init\_memory\_allocation()}{init\_memory\_allocation()}}
{\footnotesize\ttfamily void init\+\_\+memory\+\_\+allocation (\begin{DoxyParamCaption}\item[{void $\ast$}]{start\+\_\+addr,  }\item[{size\+\_\+t}]{size }\end{DoxyParamCaption})}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mem_8h_a350fdfeaa16470a038585904910c0973}\label{mem_8h_a350fdfeaa16470a038585904910c0973}} 
\index{mem.h@{mem.h}!init\_memory\_region@{init\_memory\_region}}
\index{init\_memory\_region@{init\_memory\_region}!mem.h@{mem.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{mem_8h_a18e1848dd1f6ac2ef3a214ef6b157af2}\label{mem_8h_a18e1848dd1f6ac2ef3a214ef6b157af2}} 
\index{mem.h@{mem.h}!print\_memory\_info@{print\_memory\_info}}
\index{print\_memory\_info@{print\_memory\_info}!mem.h@{mem.h}}
...
None. 
\end{DoxyReturn}
\mbox{\Hypertarget{mem_8h_a53bcc9c1f4fe098b102b72a97af1cb38}\label{mem_8h_a53bcc9c1f4fe098b102b72a97af1cb38}} 
\index{mem.h@{mem.h}!print\_node\_info@{print\_node\_info}}
\index{print\_node\_info@{print\_node\_info}!mem.h@{mem.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{mem_8h_a7b9a0e78f9993c8f45e8ccaea7f14dd5}\label{mem_8h_a7b9a0e78f9993c8f45e8ccaea7f14dd5}} 
\index{mem.h@{mem.h}!sys\_allocate\_memory@{sys\_allocate\_memory}}
\index{sys\_allocate\_memory@{sys\_allocate\_memory}!mem.h@{mem.h}}
...
Function Name\+: sys\+\_\+allocate\+\_\+memory Description\+: Allocates a consecutive bunch of memory blocks and updates the linked list.

Parameters\+: size (int) -\/ The size of memory to allocate in bytes.
...
\end{DoxyReturn}
\mbox{\Hypertarget{mem_8h_a406fd90a3f95c858165853e109fe7271}\label{mem_8h_a406fd90a3f95c858165853e109fe7271}} 
\index{mem.h@{mem.h}!sys\_free\_memory@{sys\_free\_memory}}
\index{sys\_free\_memory@{sys\_free\_memory}!mem.h@{mem.h}}
...
Function Name\+: sys\+\_\+free\+\_\+memory Description\+: Frees memory blocks starting from the specified address and updates the linked list.

Parameters\+: addr (void$\ast$) -\/ The address of the memory to free.
...
\end{DoxyReturn}
\mbox{\Hypertarget{mem_8h_aa2cb60350e8b0887063d3976054b6769}\label{mem_8h_aa2cb60350e8b0887063d3976054b6769}} 
\index{mem.h@{mem.h}!sys\_reallocate\_memory@{sys\_reallocate\_memory}}
\index{sys\_reallocate\_memory@{sys\_reallocate\_memory}!mem.h@{mem.h}}
...
Reallocates memory for a previously allocated block and updates the linked list. 

Function Name\+: sys\+\_\+reallocate\+\_\+memory Description\+: Reallocates memory for a previously allocated block and updates the linked list.

Parameters\+: addr (void$\ast$) -\/ The address of the memory block to reallocate. old\+\_\+size (int) -\/ The current size of the memory block in bytes. new\+\_\+size (int) -\/ The new size to which the memory block should be reallocated.

Return\+: void$\ast$ -\/ The new address of the reallocated memory block.

\begin{DoxyWarning}{Warning}
This function deallocates the addr value.
\end{DoxyWarning}
